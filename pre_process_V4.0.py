...
# Example usage
input_folder = 'fp_scale/data/Normal'  # Replace with the path to your input folder
output_folder = 'fp_scale/data/post_processed/Normal'  # Replace with the path to your output folder
