...
sc = plt.scatter(pca_result_df['PC1'], pca_result_df['PC2'], c=pca_result_df['Cluster'], cmap='viridis', alpha=0.6)
plt.xlabel('Principal Component 1')
plt.ylabel('Principal Component 2')
plt.title('PCA Result with K-means Clustering (4 clusters)')
