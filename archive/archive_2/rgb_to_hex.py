...
# Load your data
data = pd.read_csv(os.path.join(init.RESULTS_OUT_DIR, '/cleaned_data.csv'))
...
output_file_path = os.path.join(init.RESULTS_OUT_DIR, '/cleaned_data_with_hex_colors.csv')
