...
# Example usage
file1_path =  os.path.join(init.RESULTS_OUT_DIR, '/rearranged_rgb_values.csv')
file2_path = 'results/merged_zip_information.csv'
output_path = os.path.join(init.RESULTS_OUT_DIR, '/merged.csv')
